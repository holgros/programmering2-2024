'''
Detta är en klient som kan anslutas till den gamla chattservern (server.py)
Klienten är en prototyp till ett litet nätverkspel
Två "spelare" kan styra varsin cirkel från varsin klient i ett gemensamt fönster
Starta först servern, sedan klienten
'''
